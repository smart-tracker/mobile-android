...
data class LocationPoint(
    ...
    /**
     * Пульс на момент записи точки (уд/мин) с внешнего BLE-пульсометра.
     * null если датчик не подключён или последний сэмпл протух
     * (HrmManager.freshBpm — после обрыва соединения устаревшее значение
     * не размазывается по треку).
     */
